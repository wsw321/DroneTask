...
def main():
    ...
    parser.add_argument('-d', '--dataset', type=str, default='ReID')
    parser.add_argument('-m', '--model', type=str, default='osnet_ain_x1_0')
    parser.add_argument('--weights', default='/home/wangsw/projects/pro_visdrone_new/Yolov5_StrongSORT_OSNet/weights/reid_ped/osnet_ain_x1_0_duke2mar_cos.pth', type=str)
    parser.add_argument('--save-dir', type=str, default='activateMap')
