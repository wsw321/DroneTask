...
__all__ = [
    'osnet_ain_x1_0', 'osnet_ain_x0_75', 'osnet_ain_x0_5', 'osnet_ain_x0_25', 'osnet_ain_x1_0_my'
]
...
class OSNet(nn.Module):
    ...
    def forward(self, x, return_featuremaps=False):
        ...
        if self.loss == 'softmax':
            return y
        elif self.loss == 'triplet':  # actually, add these two loss together in 'triplet' mode
            return y, v
        else:
...
# Instantiation
##########
def osnet_ain_x1_0_my(num_classes=1000, pretrained=True, loss='softmax', **kwargs):
    model = OSNet(
        num_classes,
        blocks=[
    ...
    if pretrained:
        init_pretrained_weights(model, key='osnet_ain_x1_0_my')
    return model
