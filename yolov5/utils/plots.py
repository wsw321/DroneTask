...
class Annotator:
    ...
    def box_label(self, box, label='', color=(128, 128, 128), txt_color=(255, 255, 255)):
        ...
        if self.pil or not is_ascii(label):
            ...
            cv2.rectangle(self.im, p1, p2, color, thickness=self.lw, lineType=cv2.LINE_AA)  # thickness=self.lw-1, TODO: modified
            if label:
                tf = max(self.lw - 100, 1)  # font thickness TODO: modified tf = max(self.lw - 1, 1)
                # tf = max(self.lw - 100, 1)
                w, h = cv2.getTextSize(label, 0, fontScale=self.lw /1.5 , thickness=tf)[0]  # text width, height TODO: modified---
                ...
                cv2.putText(self.im,
                            ...
                            0,
                            self.lw / 1.5,  # self.lw / 6, TODO: modified---
                            txt_color,
                            thickness=tf,
